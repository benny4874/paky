...
public abstract class ReservationManager<T extends Addressable, I extends Serializable,K extends AddressableFinder<T,I>> {
    ...
    protected void exists(I SubjectId) {
      subjectRepository.findById(SubjectId)
              .orElseThrow(() -> raiseSubjectNotFound(SubjectId));
