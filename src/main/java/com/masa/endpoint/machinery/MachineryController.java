...
public class MachineryController {
    ...
    public MachineryController(VendorRepository vendorRepository,
    ...
    public HttpResponse<MachineryAnswer> assign(
        ...
        try {
            ...
            return notFound(new MachineryAnswer("Vendor not found with Id: " + machineryData.getVendorId()));
        }
    }
    ...
    private void bind(Machinery machinery, Recipe recipe) {
        final MachineryRecipeLoader machineryRecipeLoader = new MachineryRecipeLoader(recipe, machinery, recipeRepository, machineryRepository);
    ...
    private Machinery getMachinery(String machineryId) {
        return machineryRepository.findById(machineryId)
                .orElseThrow(
                        () -> new MachineryNotFoundException(machineryId)
                );
    }


    @Get("{machineryId}")
    public HttpResponse<MachineryDataAnswer> findById(@PathVariable(value = "machineryId") String machineryId) {
    ...
    public HttpResponse<MachineryAnswer> refill(@PathVariable(value = "machineryId") String machineryId,
