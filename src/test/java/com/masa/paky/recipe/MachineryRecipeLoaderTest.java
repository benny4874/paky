...
class MachineryRecipeLoaderTest {
    ...
    @Captor
    ArgumentCaptor<Machinery> machineryCaptor;
    ...
    void load_saveRecipe() {
        MachineryRecipeLoader underTest = new MachineryRecipeLoader(recipe, machinery, recipeRepository, machineryRepository);
        underTest.load();
    ...
    void load_notExistingMachine_throesMachineryNotFoundException() {
        MachineryRecipeLoader underTest = new MachineryRecipeLoader(recipe, aGivenMachineThatNotExists(), recipeRepository, machineryRepository);
