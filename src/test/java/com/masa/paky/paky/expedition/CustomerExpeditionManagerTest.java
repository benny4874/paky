...
class CustomerExpeditionManagerTest {
    @Mock
    AddressableFinder<Customer, String> repository;
    @Mock
    ...
    void paky_sentToWrongCustomer_ThrowDestinationMissMatchException() {
        ...
        assertThrows(
                DestinationMissMatchException.class, () -> underTest.send(fixture.getIdPaky(), "aCustomer")
        );
    }
    ...
    @CsvSource({"aPaky,aCustomerThatNotExists,aCustomerThatNotExists", "aPaky,aCustomer,anotherCustomer"})
    ...
    @NullAndEmptySource
    @ValueSource(strings = {"aCustomerThatNotExists"})
    void paky_receivedNotExistingCustomer_ThrowCustomerNotFoundException(String notExistingCustomerId) {
        Paky fixture = agivenPakySent();
        fixture.setCustomerId(notExistingCustomerId);
        assertThrows(
                CustomerNotFoundException.class,
